            ...
            <div className="container">
                ...
                <div>
                    <div className="grid grid-cols-1 gap-24 lg:grid-cols-5 sm:grid-cols-2">
                        <div className="category_block relative flex items-end justify-start w-full text-left bg-center bg-cover h-345 opacity-100 hover:opacity-90 transition-all cursor-pointer rounded" style={{ backgroundImage: `url(${pic1})` }}>
