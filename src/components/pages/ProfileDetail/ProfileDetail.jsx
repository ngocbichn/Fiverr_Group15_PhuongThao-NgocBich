...
import { layDSdathue } from '../../../store/workManage/workManageReducer';
...
const ProfileDetail = () => {
    ...
    useEffect(() => {
        dispatch(layDSdathue())
    },[])
    const {userInfo} = useUserManage()
    const {DSdathue} =useWorkManage()
            ...
            return (
                ...
                <div className='Lists'>
                    {DSdathue?.map((CV) => {
                        ...
                        <img style={{ width: '200px', height: '150px' }} src={CV.congViec.hinhAnh} alt="" />
                        <div className='listContent'>
                            <h2>{CV.congViec.tenCongViec}</h2>
                            ...
                            <div className='userCard'>
                                ...
                                <div className='cardContent'>
                                    <div className='userInfo'>
                                        <img src={userInfo.avatar} style={{ width: '150px', height: '150px', borderRadius: '50%', margin: '10px auto' }} alt="" />
                                        <p> {userInfo.name} </p>
                                        <button onClick={() => navigate(`/editprofile/${userInfo.id}`)}>
